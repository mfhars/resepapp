...
<div>
        ...
        <h1>Laksamana Measdasdngssamuk Asli Riau</h1>
        <!-- <h2>Header 2</h2>
    <h3>Header 3</h3>
    <h4>Header 4</h4>
    <h5>Headsdasder 5</h5>
    ...
    <div id="bdi_test">
        ...
        <p>
            ...
            If the bdi element is not supported in the browser, the username of the Arabic user would confuse the text
            (the bidirectional algorithm would put the colon and the number "90" next to the word "User" rather than
    ...
    <div>
        <table>
            ...
            <tr>
                <td>Data 1</td>
                <td>Long Data 2</td>
                <td>Really, realllllly, long data 3</td>
            </tr>
            <tr>
                <td>Data 1</td>
                <td>Long <b>Data</b> 2</td>
                <td>Really, realllllly, long data 3</td>
            </tr>
            <tr>
                <td>Data 1</td>
            ...
            <tr>
                <td>Different 1</td>
                <td>Different reallllllly long 2</td>
                <td>Diff 3</td>
            </tr>
            <tr>
...
class ScreenKonten1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
          ...
          children: <Widget>[
            Image.network(
              'http://4.bp.blogspot.com/-0kywwALfUoM/VMuOSvSt2zI/AAAAAAAAAL8/o-0OCeAgE4w/s1600/1357292149detail_ABB-sa01-copy_laksamana_mengamuk_jinus_257.jpg',
            ),
            Html(
              data: globalHTML,
              // //Optional parameters:
